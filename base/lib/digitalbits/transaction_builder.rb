  ...
  class TransactionBuilder
    ...
    def build_fee_bump(inner_txe:)
      ...
      if @base_fee < inner_base_fee_rate
        raise "Insufficient base_fee, it should be at least #{inner_base_fee_rate} nibbs."
      end
    ...
    def set_ledger_bounds(min_ledger, max_ledger)
      ...
      @ledger_bounds = DigitalBits::LedgerBounds.new(
    ...
    def build_preconditions
      return DigitalBits::Preconditions.new(:precond_time, @time_bounds) unless has_v2_preconditions?

      DigitalBits::Preconditions.new(
        :precond_v2,
        DigitalBits::PreconditionsV2.new(
          time_bounds: @time_bounds,
          ledger_bounds: @ledger_bounds,
