  ...
  class Operation
    ...
    class << self
      ...
      def make(body:, source_account: nil)
        raise ArgumentError, "Bad :source_account" if source_account && !source_account.is_a?(DigitalBits::KeyPair)

        body = DigitalBits::Operation::Body.new(*body)
      ...
      #
      # @param [DigitalBits::KeyPair, nil] source_account the source account for the operation
      # @param [DigitalBits::KeyPair] destination the account to merge into
      #
      # @return [DigitalBits::Operation] the built operation
      ...
      def set_options(set: [], clear: [], home_domain: nil, signer: nil, inflation_dest: nil, source_account: nil, **attributes)
        ...
        op = SetOptionsOp.new(
          set_flags: DigitalBits::AccountFlags.make_mask(set),
          clear_flags: DigitalBits::AccountFlags.make_mask(clear),
      ...
      #
      # @param [DigitalBits::KeyPair] source_account the source account for the operation
      ...
      def change_trust(asset: nil, limit: nil, source_account: nil, **attrs)
        if attrs.key?(:line) && !asset
          DigitalBits::Deprecation.warn("`line` parameter is deprecated, use `asset` instead")
          asset = attrs[:line]
        end
      ...
      # @see https://github.com/xdbfoundation/ruby-digitalbits-sdk/tree/master/base/examples/claimable_balances.rb
      #
      # @param source_account [KeyPair, nil] the source account for the operation
      ...
      #
      # @param source_account [KeyPair, nil] the source account for the operation
      # @param [DigitalBits::KeyPair] destination the receiver of the payment
      ...
      #
      # @param source_account [KeyPair, nil] the source account for the operation
      # @param destination [DigitalBits::KeyPair] the receiver of the payment
      ...
      # @param path [Array<DigitalBits::Asset>] the payment path to use
      #
      # @return [DigitalBits::Operation] the built operation
      ...
      # @param [String, Numeric, DigitalBits::Price] min_price the minimum valid price of asset A in terms of asset B
      # @param [String, Numeric, DigitalBits::Price] max_price the maximum valid price of asset A in terms of asset B
      #
      # @return [DigitalBits::Operation] the built operation
