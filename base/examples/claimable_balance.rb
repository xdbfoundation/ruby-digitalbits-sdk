...
base_endpoint = URI("https://frontier.testnet.digitalbits.io/")
...
# https://testnet.xdbexplorer.com/address/GCLR75LIUXITGNHSKF7WAEJEWZTIVACKHFMYZTQCP4SKW5MCFXMZODWM
sponsor_keypair = KeyPair("SAR2GU5YPVG2Y5I4OSQN2O3WTGSTTENSNUOVNO2LHPMC4B32W4Z2YNPB")

# https://testnet.xdbexplorer.com/address/GDQLZTJBZT2KSDYWTS6TGCVSPNG6XXOLBMG3SXVFENASZTPKN4UPNAYV
claimant_keypair = KeyPair("SDHNCLQ2JJDGBCZFLSIP5PGHFJXZMA6SH4Y5PRT4HJLR7ZYFAL74VSCU")

tx_create = DigitalBits::TransactionBuilder.create_claimable_balance(
    network_passphrase: network_passphrase,
    source_account: sponsor_keypair,
    sequence_number: fetch_sequence.(sponsor_keypair.address) + 1,
    asset: DigitalBits::Asset.native,
    amount: 100,
    claimants: [
...
tx_result = DigitalBits::TransactionResult.from_xdr(tx_create_response[:result_xdr], "base64")
...
tx_claim = DigitalBits::TransactionBuilder.claim_claimable_balance(
  network_passphrase: network_passphrase,
